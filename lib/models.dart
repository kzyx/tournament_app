...
class SeriesRound {
  // This was generated by the CodeTyper.io, and should most likely be removed.
  SeriesRound({
    required this.number,
  });
  ...
  factory SeriesRound.fromRawJson(String str) =>
      SeriesRound.fromJson(json.decode(str));
